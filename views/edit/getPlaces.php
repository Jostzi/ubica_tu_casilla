        ...
        echo "<table class='table table-hover table-sm'>";
            echo "<thead class='thead-light'>";
                echo "<tr class='d-flex'>";
                    echo "<th class='col-xs-6 col-sm-4 col-md-3 col-lg-3 text-truncate'>Casilla</th>";
                    echo "<th class='d-none d-sm-block col-sm-4 col-md-5 col-lg-5 text-truncate'>Description</th>";
                    echo "<th class='d-none d-sm-block col-sm-3 col-md-3 col-lg-3 text-truncate'>Direccion</th>";
            ...
            while($row = mysqli_fetch_array($result)){
                echo "<tr class='d-flex'>";
                    echo "<td class='col-xs-6 col-sm-4 col-md-3 col-lg-3 text-truncate'>" . $row['Casilla'] . "</td>";
                    echo "<td class='col-sm-4 col-md-5 col-lg-5 text-truncate'>" . $row['description'] . "</td>";
                    echo "<td class='col-sm-4 col-md-5 col-lg-5 text-truncate'>" . $row['address'] . "</td>";

                    // Insert parameters for update function into a variable
                    $parameters = $row['id'].",\"".$row['Casilla']."\",\"".$row['description']."\",\"".$row['openinghour']."\",\"".$row['closinghour']."\",\"".$row['lat']."\",\"".$row['lng']."\"";
                ...
                echo "<td colspan='4'>
                        <span>Are you sure you want to delete ".$row['Casilla']."?</span>
