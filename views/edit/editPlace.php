...
// Perform query
$sql = "UPDATE places SET Casilla='$Casilla', description='$description', address='$address', lat='$lat', lng='$lng', openinghour='$openinghour', closinghour='$closinghour' WHERE id='$id'";
// Return status
